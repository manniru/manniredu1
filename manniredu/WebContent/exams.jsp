...
<a href="<%=this.getServletContext().getContextPath() %>/exams">Generate Excel File</a>
<label>Upload</label><input type="file" name="upfile">
<input type="submit" value="Upload & Compute" class="form-submit">
</div></form>
